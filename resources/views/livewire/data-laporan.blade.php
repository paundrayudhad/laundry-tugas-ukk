<div>
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                ...
                <button wire:click="$refresh" class="btn btn-primary">Filter</button>
                <a href="{{ route('laporan.download', request()->all()) }}" class="btn btn-success">Unduh Laporan</a>

        <div class="table-responsive mt-4">
            <table class="table table-hover table-striped" wire:poll.5s.visible>
                <thead>
                    <tr>
                        <th>ID Transaksi</th>
                        <th>Nama Penerima</th>
                ...
                <tbody>
                    ...
                    @endphp
                         <tr wire:key="transaksi-{{ $data->id }}">
                            ...
                            <td><span class="badge badge-{{$warna}}">{{ $data->status }}</span></td>
    ...
    <div wire:show="showModal">
        <!-- Overlay -->
        <div class="modal-overlay @if($showModal) show @endif"></div>
